<template>
  <div>
    ...
    <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">
      Autentifică-te în contul tău</h2>
    <p class="mt-2 text-center text-sm text-gray-600">
      sau
      {{ ' ' }}
      <router-link :to="{name: 'roRegister'}" class="font-medium text-indigo-600 hover:text-indigo-500">
  ...
  <form class="mt-8 space-y-6" @submit="login">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center">
        ...
        <label for="remember-me" class="ml-2 block text-sm text-gray-900"> Salvează datele </label>
      </div>

      <div class="text-sm">
        <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500"> Ți-ai uitat parola? </a>
      </div>
    </div>
