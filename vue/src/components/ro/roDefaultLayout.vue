        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <a href="/home">
                <img class="h-14 w-14" src="../../assets/logogray.png" alt="logo"/>
              </a>
            </div>
      ...
      <DisclosurePanel class="md:hidden">
        ...
        <div class="pt-4 pb-3 border-t border-gray-700">
          <div class="flex items-center px-5">
            <div class="flex-shrink-0">
              <img class="h-10 w-10 rounded-full" src="../../assets/logodark.png" alt="logo"/>
            </div>
            <div class="ml-3">
...
import roFooter from "./roFooter.vue";
...
const navigation = [
  ...
  {name: 'Laboratoare Virtuale', to: {name: "Laboratoare Virtuale"}},
];
...
export default {
  components: {
    ...
    BellIcon, MenuIcon, XIcon, roFooter,
  },
