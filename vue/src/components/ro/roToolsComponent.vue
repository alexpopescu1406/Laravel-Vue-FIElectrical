      ...
      <div class="col-sm-12 mb-20">
        <div class="section-title text-center">
          ...
          <h2 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl title">
            Instrumente de calcul pentru Ingineria Electrică</h2>
        </div>
        <p class="text-base text-indigo-600 font-semibold tracking-wide uppercase text-center text-xl">Calculatoare folositoare</p>
      </div>
    </div>
...
function deleteTool(tool) {
  if (
    confirm(
      `Ești sigur că dorești să ștergi acest Instrument?!`
    )
  ) {
