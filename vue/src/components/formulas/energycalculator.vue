              ...
              <td>
                <div class="form-group text-white text-2xl font-extrabold">
                  <select v-model="voltageNew.unit" class="form-control">
                    <option v-for="unit in voltageUnitsNew" :key="unit.text" :value="unit.value" v-text="unit.text">
              ...
              <td>
                <div class="form-group">
                  <select v-model="currentNew.unit" class="form-control">
                    <option v-for="unit in currentUnitsNew" :key="unit.text" :value="unit.value" v-text="unit.text">
                    </option>
                  </select>
                </div>
              </td>
              ...
              <td>
                <div class="form-group">
                  <select v-model="resistanceNew.unit" class="form-control">
                    <option v-for="unit in resistanceUnitsNew" :key="unit.text" :value="unit.value" v-text="unit.text">
              ...
              <td>
                <div class="form-group">
                  <select v-model="timeNew.unit" class="form-control">
                    <option v-for="unit in timeUnitsNew" :key="unit.text" :value="unit.value" v-text="unit.text">
              ...
              <td>
                <div class="form-group">
                  <select v-model="energyInWattHours.unit" @change="calculateNew" class="form-control">
                    <option v-for="unit in energyInWattHoursUnits" :key="unit.text" :value="unit.value" v-text="unit.text">
